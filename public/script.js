...
function main() {
    ...
    // --- CORRECTED CONSOLE.ERROR OBJECT ---
    if (!steps || steps.length === 0 || criticalElements.some(el => !el)) {
        console.error("[Client] Critical UI elements missing from the DOM. Aborting initialization.", {
            wizard: !!wizard, // Use !! or just wizard
            steps: steps?.length, // OK as is
            sectionsContainer: !!sectionsContainer, // Use !! or just sectionsContainer
            addSectionBtn: !!addSectionBtn, // etc.
            calculateBtn: !!calculateBtn,
            resultsDiv: !!resultsDiv,
            startOverBtn: !!startOverBtn,
            printBtn: !!printBtn,
            toggleExampleBtn: !!toggleExampleBtn,
            exampleImageDiv: !!exampleImageDiv,
